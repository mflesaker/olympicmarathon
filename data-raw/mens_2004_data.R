...
library(htm2txt)
url <- 'https://www.worldathletics.org/results/olympic-games/2994/the-xxvii-olympic-games-6913163/men/marathon/final/result'
olympic_2004_raw_men <- gettxt(url)

mens_2004_data <- olympic_2004_raw_men %>%
  strsplit("\n")

mens_2004_data <- as.character(mens_2004_data[[1]][233:435])
