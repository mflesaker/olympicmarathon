...
`times_over_time` is a simple function provided by the package which takes no arguments. It displays every complete finishing time over the years by gender. 
