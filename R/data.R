...
#' @format `mens_2020_data` is an object of class tbl_df (inherits from tbl, data.frame) with 106 rows and 9 columns
#'
...
#' @docType data
#' @description
#' `womens_2016_data` contains data from the 2016 Rio de Janeiro Olympics Women's Marathon
#' @usage womens_2016_data
#' @format `womens_2016_data` is an object of class tbl_df (inherits from tbl, data.frame) with 157 rows and 9 columns
#'
...
#' @format `mens_2016_data` is an object of class tbl_df (inherits from tbl, data.frame) with 155 rows and 9 columns
#'
